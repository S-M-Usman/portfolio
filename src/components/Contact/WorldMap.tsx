...
export default function WorldMap({ dots = [], lineColor = "#0ea5e9" }: MapProps) {
  ...
  const pakistanCoords = { lat: 30.3753, lng: 69.3451 }
  ...
  return (
    <div className="w-full aspect-[2/1] rounded-lg relative font-sans">
      ...
      >
        ...
        <g>
          <circle
            cx={projectPoint(pakistanCoords.lat, pakistanCoords.lng).x}
            cy={projectPoint(pakistanCoords.lat, pakistanCoords.lng).y}
            r="4"
            fill={lineColor}
          />
          <circle
